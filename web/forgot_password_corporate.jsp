  ...
  <title>Common Corporate Social Responsibility Portal</title>
    <link href="main.css" rel="stylesheet" media="all">
      ...
      function validate_individual_login(){
        ...
        var uname=document.forms["individual_login_form"]["corporate_username"].value;
        if(uname.length<1)
          {
             alert("Please Enter Your Username");
             return false;
          }
          var mail=document.forms["individual_login_form"]["head_mail"].value;
          var mobile=document.forms["individual_login_form"]["head_mobile"].value;
    ...
    <div class="page-wrapper p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" name="individual_login_form" action="forgot_password_corporate_process.jsp" onsubmit="return validate_individual_login()">
                	...
                	<div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="name">Head E-mail Id</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="emai" name="head_mail">
                                </div>
                            </div>
                        </div>
						
                        <div class="form-row">
                            <div class="name">Head Mobile No.</div>
                            <div class="value">
                                <div class="input-group">
